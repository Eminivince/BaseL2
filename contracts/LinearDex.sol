...
contract LinearDex is IERC20, Ownable {
    ...
    string private _name = "LinearDex";
    string private _symbol = "LDX";
    uint8 private _decimals = 18;
    uint256 private _preMintSupply = 100000 * 10 ** 18;
    ...
    function mint(address _to, uint256 _amount) public onlyMinter returns (bool) {
        if (_amount + _totalSupply > maxSupply) {
            return false;
        }
        _mint(_to, _amount);
        return true;
    ...
    function setMinter(address _addr, bool _isMinter) public onlyOwner {
        _minters[_addr] = _isMinter;
    }
}